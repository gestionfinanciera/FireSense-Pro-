...
const RaffleScreen: React.FC<RaffleScreenProps> = ({ language, onBack }) => {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col" dir={isArabic ? 'rtl' : 'ltr'}>
      {/* Header */}
      ...
      <main className="flex-1 p-6 flex flex-col items-center text-center">
        ...
        {/* Rules Desc */}
        <p className="text-gray-600 font-medium leading-relaxed mb-8 max-w-xs">
          {text.raffleRulesDesc}
        </p>

        {/* Steps */}
        <div className="space-y-2 mb-8 text-gray-800 font-bold">
        ...
        {/* Ticket Counter */}
        <div className="bg-gray-100 px-6 py-2 rounded-lg border border-gray-200 flex items-center space-x-2 rtl:space-x-reverse mb-4">
           <svg className="w-5 h-5 text-gray-900" fill="currentColor" viewBox="0 0 20 20">
              <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
           </svg>
           <span className="font-bold text-gray-900">{text.raffleTicketLabel}</span>
        </div>
        ...
        {/* YouTube Hint */}
        <p className="text-sm text-gray-800 font-bold px-4 mb-6 leading-relaxed">
        ...
        <div className="w-full max-w-xs mb-4">
          <input 
            ...
            className="w-full bg-white border border-gray-300 rounded-xl py-4 px-6 text-center font-bold text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#FF1E1E]/20"
          />
        </div>

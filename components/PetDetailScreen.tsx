  ...
  return (
    <div className="min-h-screen bg-white flex flex-col animate-in fade-in slide-in-from-right duration-300" dir={isArabic ? 'rtl' : 'ltr'}>
      ...
      <main className="flex-1 p-6 space-y-8 overflow-y-auto">
        {/* Imagen en Tarjeta Blanca con brillo sutil rojo */}
        <div className="bg-white rounded-[2.5rem] border border-gray-100 shadow-[0_10px_30px_rgba(255,30,30,0.05)] p-6 flex items-center justify-center min-h-[250px]">
           <img 
             src={pet.imageUrl} 
             alt={pet.name} 
        ...
        {/* Título de Habilidad con acento rojo */}
        ...
        {/* Sección Habilidad Técnica con borde rojo neón lateral */}
        <div className="space-y-4 px-4 border-l-4 border-[#FF1E1E] bg-red-50/30 py-4 rounded-r-2xl">
